...
import { DashboardTabs } from "./client";

export default async function DashboardPage() {
  const [session, summary] = await Promise.all([getSession(), dashboardApi.getSummary()]);
    ...
    <>
      ...
      <div className="flex w-full flex-1 flex-col items-start gap-8 overflow-y-auto bg-slate-50 p-8">
        <PageHeader
          ...
          actions={<SearchInput value="" onChange={() => {}} placeholder="Search room" />}
        />
